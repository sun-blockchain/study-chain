...
# node invoke.js --username=adminacademy --func=CreateClass --classCode=ETH101 --room=F13 --time="11:00" --shortDescription=Ethereum --description="Sun Research Blockchain will teach you knowledge about Ethereum. After class, you can develop a Dapp on Ethereum" --subjectId= --capacity=75
# node invoke.js --username=adminacademy --func=CreateClass --classCode=Fabric101 --room=F13 --time="13:00" --shortDescription=Hyperledger --description="Sun Research Blockchain will teach you knowledge about Hyperledger Fabric IBM. After class, you can develop Dapp on Hyperledger Fabric" --subjectId= --capacity=71
